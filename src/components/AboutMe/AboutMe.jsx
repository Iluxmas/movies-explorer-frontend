        ...
        <div className='aboutme__info'>
          ...
          <div className='aboutme__text'>
            ...
            <p className='aboutme__paragraph'>
              ...
              РХТУ им. Д.И.Менделеева. Мне нравится путешествовать, скалолазанье, сноуборд и научпоп. С 2022 года
              работаю в компании «Flying Academy» фронтенд-разработчиком, а также помогаю делать функционал для одного
              приложения в качестве фрилансера.
            </p>
